...
export default function ReadProductsPage() {
  ...
  const handleDeleteProduct = async () => {
    if (productToDelete) {
      try {
        const response = await api.delete(`/product/${productToDelete.id}`);
